...
| **`web/`** | The Flask website behind [blankthespire.com](https://blankthespire.com): sign in, forge a class (hosted, or bring your own API key), share results at `/api/deck/<slug>`, and download the mod. Forging is free and unlimited with your own API key; the hosted models run on tokens received as a thank-you for donations (the mod itself is free). |
